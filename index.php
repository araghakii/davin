...
<head>
    ...
    <title>Halaman Login | Sistem Informasi Buku Tamu Davincy</title>
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-lg-block bg-success shadow-lg p-5 text-center">
                                ...
                                <h3 class="text-white">Sistem Informasi Buku Tamu 
                                    <br> Davincy 
                                    <br><small>Batam, Kepulauan Riau</small></h3>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="forgot-password.html">By. Davincy | 2024 - <?= date('Y')?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
